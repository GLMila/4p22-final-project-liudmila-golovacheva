...
const Header = (props) => {
  ...
  const isExistInBasket = totalAmount > 0
  ...
  return (
    <header className={`${className} header`}>
      ...
      <div className='header__icons'>
        <Link to={'/feedback'} title="Перейти на страницу обратной связи">
          <svg  className='header__icons-feedback' width="22" height="25" viewBox="0 0 26 29" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Link className='header__basket' to={'/basket'} title="Перейти в корзину">
          {isExistInBasket && (
          <span className='header__amount'>{ totalAmount }</span>)}
          <svg className='header__icons-basket' width="29" height="25" viewBox="0 0 32 29" fill="none" xmlns="http://www.w3.org/2000/svg">
